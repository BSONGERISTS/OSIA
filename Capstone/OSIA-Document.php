            ...
            <div class="foldertab">
                    ...
                    <form id="fileupload" enctype="multipart/form-data" method="post" action="fileupload.php">
                        ...
                        <button type="button" class="tap">
                            ...
                            <input type="file" name="file_input" accept="application/vnd.openxmlformats-officedocument.wordprocessingml.document, application/msword, application/pdf" class="invisible" required>
                        </button>
                        <button type="Submit" class="submit_file">Submit</button>
                    </form>
            ...
            <div class="foldermessage">
                <div class="addfoldertab">
                    ...
                    <form method="post" enctype="multipart/form-data" action="addfolder.php">
                        ...
                        <input type="text" class="parent_folder" name="folder_id" value="1" hidden>
                        <input type="text" name="input_foldername" required>
