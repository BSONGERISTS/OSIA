...
<html>
    <head>
        ...
        $(document).ready(function ( $ ) {
                ...
                $( "button.directories" ).on( "click", function(){
                        var dirValue = $( this ).val();
                        console.log( dirValue );
                        $( "input.hidden_directory" ).val( dirValue );
                        $( "label.hidden_directory" ).text( dirValue );
                });
        });
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="preview">
                <iframe id="filepreview" src="" frameborder="0" height="100%" width="100%"></iframe>
            </div>
            ...
            <div class="Folders">
                ...
                if( !empty( $results ) ){
                        ...
                        foreach( $results as $key => $row ){
                                ...
                                if( !empty( $row['directory'] ) ){
                                    ...
                                    $var_directory = $row['directory'];
                                    $filename = $row['file'];
                                }
                                echo '<button type="text" class="files directories" value="'. $var_directory .'">' . $filename . '</button>';
                        }
                }
                ...
                //                 $btn = "button" . $i;
                //                 echo '<button class="files" onclick="'. $btn . '()">';
                //                     echo $file_name;
                //                 echo '</button>';
                ...
                //                         echo "document.getElementById('filepreview').setAttribute('src', '" . $directory . "');";
                //                         $directory = $folder;
                //                     }
                //                     else{
                                        
                //                         //changed value of directory going to if(is_dir($directory))
                //                     }
                //                     echo '}';
                //                 echo '</script>';
                //                 $i++;
            ...
            <div class="foldertab">
                <label class="hidden_directory">uploads/</label>
            </div>
            ...
            <!--if upload button is clicked-->
                <input type="text" id="hidden_directory" class="hidden_directory" name="hidden_directory" value="" hidden>
                <button type="button" class="tap">
                    ...
                    <input type="file" name="file" accept="application/vnd.openxmlformats-officedocument.wordprocessingml.document, application/msword, application/pdf" class="invisible" required>
                </button>
